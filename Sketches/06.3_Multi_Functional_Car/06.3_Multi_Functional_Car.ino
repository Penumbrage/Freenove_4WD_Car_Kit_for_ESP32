...
void WiFi_Init() {
  ssid_Router     =   "NETGEAR10";    //Modify according to your router name
  password_Router =   "classygiant284";    //Modify according to your router password
...
void setup() {
  ...
  WiFi_Setup(0);            //Start Station Mode
